...
import { Users2, ArrowRight, ArrowLeft, Mail } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="text-xl text-gray-600 space-y-6">
              <p>
                I'm so glad to tell you that our Community is almost ready to launch, along with Gen AI Kickstart course and our pretty amazing giant AI Goodie Bag!
              </p>
