        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center justify-center p-3 bg-[#3843d0]/10 rounded-2xl mb-8">
              <BookOpen className="h-8 w-8 text-[#3843d0]" />
            </div>
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-[#ff5ec4] mb-6">
              Coming Soon!
            </h2>

            <h3 className="text-xl md:text-2xl lg:text-3xl font-black text-gray-900 mb-8">
              EXCITING STUFF IS ON THE WAY!
            </h3>

            <div className="text-lg text-gray-600 space-y-6">
              <p>
                I'm so glad to tell you The Gen AI Kickstart Course is almost ready to launch, along with our community and our pretty amazing giant AI Goodie Bag!
              </p>
