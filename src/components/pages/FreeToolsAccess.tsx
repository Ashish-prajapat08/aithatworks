      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="bg-gradient-to-br from-[#3843d0] to-[#ff5ec4] p-1 rounded-3xl shadow-2xl">
            <div className="bg-white rounded-3xl p-10 md:p-14 text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Click below to access your complete collection of AI resources,
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Validate demand before you create. Research competitors.
                Generate ideas that actually work. Every prompt you need to
                build an audience.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                300+ business ideas across professional services, e-commerce,
                and digital products. Each includes AI tools, investment levels,
                and starter prompts.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Two levels for every task. Start simple or go deep. Test what
                works for you.
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <p className="text-center text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Every two weeks, I'll send you a newsletter with practical AI
              tips, new prompts and workflows I'm actually using, and AI news
              without the hype.
            </p>
            <p className="text-center text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              No extra fluff. Just tips, tools and workflows that get results in
              minutes.
            </p>
            ...
            <div className="border-t-2 border-gray-300 border-b-2 py-8 my-8">
              ...
              <p className=" text-center text-lg text-gray-600 leading-relaxed mb-4 mx-auto max-w-3xl">
                An all-in-one AI community with advanced training, custom AI
                assistants, advanced prompt processes, and monthly live sessions
                where we tackle real implementation challenges together.
                Newsletter subscribers will hear about it first.
              </p>
              <p className=" text-center text-lg text-gray-600 leading-relaxed">
                For now, dig into the toolkit. Test what works for your
                situation. I'd love to know what you try.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-[#ffeef8] to-[#f3e7ff] rounded-3xl p-10 md:p-12 text-center border-2 border-gray-200">
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-6">
              Ready to Go Deeper?
            </h2>

            <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8 leading-relaxed">
              The toolkit gives you the prompts. Workshops show you how to
              actually implement them in your business. I work with teams who
              want to stop wondering how AI fits and start using it effectively.
            </p>
